...
import com.ylink.aml.core.interceptor.GunsUserFilter;
import com.ylink.aml.core.shiro.ShiroDbRealm;
...
public class ShiroConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = GunsProperties.PREFIX, name = "spring-session-open", havingValue = "false")
