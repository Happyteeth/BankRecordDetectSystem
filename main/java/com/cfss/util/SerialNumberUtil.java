...
public class SerialNumberUtil {
    ...
    private static void executeMacCmd(String cmd) {
...
//            p.destroy();
    ...
    public static Map<String, String> getAllSn(){
        ...
        if("LINUX".equals(os)) {
            ...
            String serialNumber = 	getSerialNumber("system_profiler SPHardwareDataType | grep 'Serial Number (system)'", "Serial Number (system)",":");
            System.out.println("SerialNumber -> : "+ serialNumber);
            String hardwareUuid = getSerialNumber("system_profiler SPHardwareDataType | grep 'Hardware UUID'", "Hardware UUID",":");
    ...
    public static void main(String[] args) {
        String drive ="c";
        System.out.println("主板序列号为："+getMotherboardSN());
        System.out.println("driver:"+getHardDiskSN(drive));
        System.out.println("cpu:"+getCPUSerial());
        System.out.println("mac:"+getCPUSerial());
    }
}
